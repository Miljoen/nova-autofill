...
Nova.booting(function (Vue) {
  Vue.component('index-nova-autofill', __webpack_require__(4));
  Vue.component('detail-nova-autofill', __webpack_require__(7));
  Vue.component('form-nova-autofill', __webpack_require__(10));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        onClick: function onClick() {
            var selectedSpan = document.getElementsByClassName('vs__selected')[0];
        ...
        onChange: function onChange(value) {
            ...
            var selectedObject = this.field.objects.find(function (object) {
                return object[_this.field.filterKey] === value;
            });
            var selectedSpan = document.getElementsByClassName('vs__selected')[0];
            ...
            Object.keys(selectedObject).forEach(function (objectAttribute) {
                var inputField = document.getElementById(objectAttribute);
                if (inputField) {
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          {
            staticClass: "dropdown-container input-append",
